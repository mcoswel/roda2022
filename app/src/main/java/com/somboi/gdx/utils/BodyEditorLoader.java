...
public class BodyEditorLoader {
    ...
    World world = new World(new Vector2(0, -9), false);
     ...
     */
    public void attachFixture(Body body, String name, FixtureDef fd, float scale, String userData) {
